...
```
User calls: nccl_ofi_freelist_entry_alloc(freelist)
    ↓
Lock freelist mutex
    ↓
...
```
User calls: nccl_ofi_freelist_entry_free(freelist, entry)
    ↓
Lock freelist mutex
    ↓
...
┌─────────────────────────────────────────────────────┐
│                  Block Memory                        │
│  (page-aligned, registered with fi_mr_reg)          │
├──────────┬──────────┬──────────┬──────────┬─────────┤
